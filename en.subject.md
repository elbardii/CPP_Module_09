...
- [Chapter II: General rules](#chapter-ii)
- [Chapter III: Module-specific rules](#chapter-iii)
- [Chapter IV: AI Instructions](#chapter-iv)
- [Chapter V: Exercise 00: Bitcoin Exchange](#chapter-v)
- [Chapter VI: Exercise 01: Reverse Polish Notation](#chapter-vi)
- [Chapter VII: Exercise 02: PmergeMe](#chapter-vii)
- [Chapter VIII: Submission and peer-evaluation](#chapter-viii)
...
This will be the starting point of your C++ journey. Many languages are recommended to learn OOP. We decided to choose C++ since it’s derived from your old friend C. Because this is a complex language, and in order to keep things simple, your code will comply with the **C++98 standard**.
...
> [!WARNING]
> You must use at least two different containers in your code to validate this exercise. Your program must be able to handle at least 3000 integers, duplicate values included.
...
> [!NOTE]
> The commands shown above (`shuf`, `jot`) are only examples used to generate an input sequence. Your program must handle any sequence of positive integers, including repeated values.
